...
function MouseManager()
{
	...
	{		
		...
		MouseManager.self.m_externalLogString = "rect x,y=" + rect.left + "," + rect.top + ", touch x,y=" + e.clientX + "," + e.clientY;
	...
	MouseManager.prototype.touchXY = function(e)
	{
		...
		if ((typeof e !== 'undefined'))
		{
			...
			var rect = MouseManager.self.m_canvasEx.m_canvas.getBoundingClientRect();
			rect.left = (window.innerWidtht / 2) - (MouseManager.self.m_canvasEx.m_canvasWidth /2);
			rect.top = (window.innerHeight / 2) - (MouseManager.self.m_canvasEx.m_canvasHEight /2);
			...
			if ((typeof e.targetTouches[0] !== 'undefined') && (typeof e.targetTouches[0] !== 'undefined'))
			{
				...
				MouseManager.self.m_externalLogString = "rect x,y=" + rect.left + "," + rect.top + ", touch x,y=" + e.targetTouches[0].clientX + "," + e.targetTouches[0].clientY;
			}
			else if ((typeof e.changedTouches[0] !== 'undefined') && (typeof e.changedTouches[0] !== 'undefined'))
			{
				...
				//MouseManager.self.m_externalLogString = "rect=" + rect.left + ", touch=" + e.changedTouches[0].clientX;
			}
