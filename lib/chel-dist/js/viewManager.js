...
{ 
	...
	msglog("HOST HOST HOST:" + this.m_hostname);
...
ViewManager.prototype.getCanvasEx = function ()
{
	return this.m_canvasEx;
}

ViewManager.prototype.getWidth = function ()
{
	return this.m_canvasEx.m_canvas.width;
}

ViewManager.prototype.getHeight = function ()
{
	return this.m_canvasEx.m_canvas.height;
}
