...
console.log(this.m_window.innerHeight )
console.log(this.m_window.innerWidth )
var mainDiv = this.m_document.getElementById("maindiv");
			
console.log(mainDiv);

mainDiv.setAttribute("style","display:block" + ";width:" + this.m_window.innerWidth + "px" + ";height:" + this.m_window.innerHeight + "px");
