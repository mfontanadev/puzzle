...
function MouseManager()
{
	...
	MouseManager.prototype.touchXY = function(e)
	{
		...
		if ((typeof e !== 'undefined'))
		{
			...
			MouseManager.self.m_externalLogString = "winHei=" + window.innerHeight + " / rect x,y=" + rect.left + "," + rect.top + ", touch x,y=" + e.targetTouches[0].clientX + "," + e.targetTouches[0].clientY;
