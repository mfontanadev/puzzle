...
function MouseManager()
{
	...
	{		
		...
		MouseManager.self.m_externalLogString = "rect=" + rect.left + ", touch=" + e.clientX;
	...
	MouseManager.prototype.touchXY = function(e)
	{
		...
		if ((typeof e !== 'undefined'))
		{
			...
			if ((typeof e.targetTouches[0] !== 'undefined') && (typeof e.targetTouches[0] !== 'undefined'))
			{
				...
				MouseManager.self.m_externalLogString = "rect=" + rect.left + ", touch=" + e.targetTouches[0].clientX;
			}
