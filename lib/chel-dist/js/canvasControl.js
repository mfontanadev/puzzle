...
CanvasControl.prototype.initKeyboardEvents = function (self)
{
  ...
  */
  ...
  {
	this.setImagePath(_imageName, "");
  };
  
  CanvasControl.prototype.setImagePath = function(_imageName, _path) 
  {
     ...
     this._controlType == this.C_CONTROL_TYPE_CHECKBOX)
    {
      ...
      this._image.src = _path + _imageName;
  ...
  {
	this.setImageDownPath(_imageName, "");
  };

  CanvasControl.prototype.setImageDownPath = function(_imageName, _path) 
  {
    if (this._controlType == this.C_CONTROL_TYPE_BUTTON ||
     this._controlType == this.C_CONTROL_TYPE_CHECKBOX)
    {
      ...
      this._imageDown.src = _path + _imageName;
