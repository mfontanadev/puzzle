...
{ 
	...
	chCanvas.prototype.performResize = function ()
	{
		...
		try
		{
			...
			msglog("in W:" + window.innerWidth + ", in H:" + window.innerHeight);
			msglog("out W:" + window.outerWidth + ", in H:" + window.outerHeight);
			msglog("avail W:" + window.screen.availWidth + ", avail H:" + window.screen.availHeight);
			msglog("scr.W:" + window.screen.width + ", scr.H:" + window.screen.height);
			
			//C_LOG = false;
		}
		catch(e)
		{
			msglog("ERROR (performResize):" + e);
		}
